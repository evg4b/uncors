...
import (
	...
	mm_processor "github.com/evg4b/uncors/internal/processor"
...
type HandlingMiddlewareMock struct {
	...
	funcWrap          func(next mm_processor.HandlerFunc) (h1 mm_processor.HandlerFunc)
	inspectFuncWrap   func(next mm_processor.HandlerFunc)
...
type HandlingMiddlewareMockWrapResults struct {
	h1 mm_processor.HandlerFunc
}

// Expect sets up expected params for HandlingMiddleware.Wrap
func (mmWrap *mHandlingMiddlewareMockWrap) Expect(next mm_processor.HandlerFunc) *mHandlingMiddlewareMockWrap {
...
func (mmWrap *mHandlingMiddlewareMockWrap) Inspect(f func(next mm_processor.HandlerFunc)) *mHandlingMiddlewareMockWrap {
...
func (mmWrap *mHandlingMiddlewareMockWrap) Return(h1 mm_processor.HandlerFunc) *HandlingMiddlewareMock {
	if mmWrap.mock.funcWrap != nil {
		mmWrap.mock.t.Fatalf("HandlingMiddlewareMock.Wrap mock is already set by Set")
	}
...
func (mmWrap *mHandlingMiddlewareMockWrap) Set(f func(next mm_processor.HandlerFunc) (h1 mm_processor.HandlerFunc)) *HandlingMiddlewareMock {
	if mmWrap.defaultExpectation != nil {
...
// Then helper
func (mmWrap *mHandlingMiddlewareMockWrap) When(next mm_processor.HandlerFunc) *HandlingMiddlewareMockWrapExpectation {
	if mmWrap.mock.funcWrap != nil {
		mmWrap.mock.t.Fatalf("HandlingMiddlewareMock.Wrap mock is already set by Set")
	}
...
func (e *HandlingMiddlewareMockWrapExpectation) Then(h1 mm_processor.HandlerFunc) *HandlingMiddlewareMock {
	e.results = &HandlingMiddlewareMockWrapResults{h1}
	return e.mock
}

// Wrap implements processor.HandlingMiddleware
func (mmWrap *HandlingMiddlewareMock) Wrap(next mm_processor.HandlerFunc) (h1 mm_processor.HandlerFunc) {
