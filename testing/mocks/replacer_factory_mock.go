...
type ReplacerFactoryMockMakeExpectation struct {
	...
	expectationOrigins ReplacerFactoryMockMakeExpectationOrigins
...
func (mmMake *mReplacerFactoryMockMake) Expect(requestURL *url.URL) *mReplacerFactoryMockMake {
	...
	mmMake.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmMake *mReplacerFactoryMockMake) ExpectRequestURLParam1(requestURL *url.URL) *mReplacerFactoryMockMake {
	...
	mmMake.defaultExpectation.expectationOrigins.originRequestURL = minimock.CallerInfo(1)
...
func (mmMake *mReplacerFactoryMockMake) When(requestURL *url.URL) *ReplacerFactoryMockMakeExpectation {
	...
	expectation := &ReplacerFactoryMockMakeExpectation{
		...
		expectationOrigins: ReplacerFactoryMockMakeExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	...
	if mmMake.MakeMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.requestURL != nil && !minimock.Equal(*mm_want_ptrs.requestURL, mm_got.requestURL) {
				mmMake.t.Errorf("ReplacerFactoryMock.Make got unexpected parameter requestURL, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmMake.MakeMock.defaultExpectation.expectationOrigins.originRequestURL, *mm_want_ptrs.requestURL, mm_got.requestURL, minimock.Diff(*mm_want_ptrs.requestURL, mm_got.requestURL))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmMake.t.Errorf("ReplacerFactoryMock.Make got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmMake.MakeMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *ReplacerFactoryMock) MinimockMakeInspect() {
	for _, e := range m.MakeMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ReplacerFactoryMock.Make at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.MakeMock.defaultExpectation != nil && afterMakeCounter < 1 {
		if m.MakeMock.defaultExpectation.params == nil {
			...
			m.t.Errorf("Expected call to ReplacerFactoryMock.Make at\n%s with params: %#v", m.MakeMock.defaultExpectation.expectationOrigins.origin, *m.MakeMock.defaultExpectation.params)
		}
	}
	...
	if !m.MakeMock.invocationsDone() && afterMakeCounter > 0 {
		m.t.Errorf("Expected %d calls to ReplacerFactoryMock.Make at\n%s but found %d calls",
